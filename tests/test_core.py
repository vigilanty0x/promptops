...
GOOD = {"benchmark":"latency","configuration":{"model":"local"},"duration_ms":120,"result":{"score":0.9},"artifacts":["report.json"]}
BAD = {"benchmark":"","configuration":{},"duration_ms":True,"result":{},"artifacts":[""]}

class ContractTests(unittest.TestCase):
    def test_valid_record_builds_domain_artifact(self):
        result = evaluate(GOOD)
        self.assertEqual(result["status"], "passed")
        self.assertEqual(result["run_manifest"]["duration_ms"], 120)
